...
using MultilingualProject.Sessions;
using MultilingualProject.Web.Models.Account;
using MultilingualProject.Web.Views.Shared.Components.TenantChange;

namespace MultilingualProject.Web.Controllers
{
    public class AccountController : MultilingualProjectControllerBase
    {
